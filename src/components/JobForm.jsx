    ...
    <div className="md-editor">
      <div className="md-editor-toolbar">
        <span className="md-editor-label">
          📋 Extra Info (Markdown)
          <span className="form-hint">paste job post, requirements, deadlines</span>
        </span>
      ...
      <div className="jf-modal">
        ...
        <div className="jf-body">
          ...
          <div className="form-grid-2">
            ...
            <Field label="CV / Resume Link" hint="GitHub URL of the CV version you submitted">
        ...
        <div className="jf-footer">
          ...
          <button className="jf-btn-save" onClick={handleSave} disabled={isSaving}>
            {isSaving ? 'Saving…' : (initialData ? '💾 Save Changes' : '✅ Save Job')}
          </button>
        </div>
      </div>
    </div>
